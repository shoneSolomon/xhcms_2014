...
define(function(require, exports, module){
	...
	var AreaSelector = function(opt){
		...
		el.attr({
			...
			holder.css({
				left: off.left + _this.width() - o.width,
				top: off.top + _this.height() + 4
			}).show();
		});
